...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La autenticación en dos pasos ya está activada. Escanea el código QR o ingresa la clave de configuración en tu app de autenticación.',
            buttonText: 'Cerrar',
        };
    }
    ...
    return {
        ...
        description:
            'Para terminar de activar la autenticación en dos pasos, escanea el código QR o ingresa la clave de configuración en tu app de autenticación',
        buttonText: 'Continuar',
    };
});
