    ...
    <div v-if="canManageTwoFactor" class="space-y-6">
        ...
        >
            <p class="text-muted-foreground text-sm">
                ...
                seguro al iniciar sesión. Ese código lo genera una aplicación
        ...
        <div v-else class="flex flex-col items-start justify-start space-y-4">
            <p class="text-muted-foreground text-sm">
                Al iniciar sesión se te pedirá un código seguro y aleatorio que
                puedes obtener de la aplicación compatible con TOTP de tu
                teléfono.
            </p>
