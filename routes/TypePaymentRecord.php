...
Route::prefix('/type_payment_record')->middleware(['auth', 'verified'])->group(function () {
    Route::put('/', [TypePaymentRecordController::class, 'store'])->middleware('permission:type_payment_record.registrar|type_payment_record.editar');
    Route::delete('/{id}/{page}', [TypePaymentRecordController::class, 'destroy'])->middleware('permission:type_payment_record.eliminar');
