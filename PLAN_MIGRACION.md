...
1. [ ] **Préstamos** — 🟡 **listado + asistente de alta hechos**
    ...
    - [ ] Pendiente Préstamos: acciones Novedades/Pausar (requieren endpoints nuevos). El módulo de **Clientes** como pantalla completa sigue pendiente (el legado nunca tuvo `store`/rutas de alta salvo `actualizaCliente`).
