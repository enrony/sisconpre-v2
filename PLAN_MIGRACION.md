...
1. [ ] **Préstamos** — 🟡 **listado + asistente de alta hechos**
    ...
    - [ ] Pendiente Préstamos: cambio de fecha de cuota (`changeDate`), acciones Novedades/Pausar (requieren endpoints nuevos), alta rápida de cliente desde el wizard (`MasterCustomers`).
