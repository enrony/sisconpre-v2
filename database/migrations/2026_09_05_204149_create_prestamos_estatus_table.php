...
return new class extends Migration
{
    ...
    {
        Schema::create('prestamos_estatus', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('grupos_trabajos_user_id')->nullable()->index('idx_gtuipe1');
    ...
    {
        Schema::dropIfExists('prestamos_estatus');
    }
};
