...
import { i as dn } from './button-CTW30sKl.js';
import { d as X, i as fn, n as pn } from './useForwardExpose-C5vAy60U.js';
var mn = e({
        BaseTransition: () => w,
        BaseTransitionPropsValidators: () => D,
        Comment: () => N,
        ...
        createPropsRestProxy: () => t,
        createRenderer: () => it,
        createSSRApp: () => at,
        createSlots: () => Ut,
        createStaticVNode: () => kt,
        createTextVNode: () => Lt,
        createVNode: () => gt,
        customRef: () => O,
        defineAsyncComponent: () => Ge,
        defineComponent: () => K,
        ...
        defineOptions: () => Kt,
        defineProps: () => tt,
        defineSSRCustomElement: () => Et,
        defineSlots: () => st,
        devtools: () => Nt,
        effect: () => P,
        effectScope: () => ie,
        getCurrentInstance: () => W,
        getCurrentScope: () => pe,
        getCurrentWatcher: () => S,
        getTransitionRawChildren: () => pt,
        guardReactiveProps: () => ut,
        h: () => H,
        handleError: () => Xt,
        hasInjectionContext: () => sn,
        hydrate: () => dt,
        hydrateOnIdle: () => Ye,
        hydrateOnInteraction: () => rn,
        hydrateOnMediaQuery: () => Se,
        hydrateOnVisible: () => f,
        ...
        resolveFilter: () => null,
        resolveTransitionHooks: () => Ot,
        setBlockTracking: () => Ft,
        setDevtoolsHook: () => mt,
        setTransitionHooks: () => Ue,
        shallowReactive: () => Pe,
        shallowReadonly: () => ze,
        shallowRef: () => L,
        ssrContextKey: () => At,
...
function bn(e, t = `reka`) {
    ...
    let n,
        r = Q({ useId: void 0 });
    return (
        (n = r.useId ? r.useId() : `useId` in mn ? U?.() : `${++yn}`),
        t ? `${t}-${n}` : n
    );
}
function xn(e, t) {
...
function Sn(e, t) {
    let n = V({}),
        ...
        o,
        s = t.value?.ownerDocument.defaultView ?? pn,
        { state: c, dispatch: l } = xn(a, {
            mounted: {
                UNMOUNT: `unmounted`,
        ...
        async (e, i) => {
            ...
            if ((await E(), a)) {
                let a = r.value,
                    o = $(t.value);
                e
                    ? (l(`MOUNT`), u(`enter`), o === `none` && u(`after-enter`))
                    : o === `none` ||
                        o === `undefined` ||
                        n.value?.display === `none`
                      ? (l(`UNMOUNT`), u(`leave`), u(`after-leave`))
                      : i && a !== o
                        ? (l(`ANIMATION_OUT`), u(`leave`))
                        : (l(`UNMOUNT`), u(`after-leave`));
            }
        },
        { immediate: !0 },
    );
    ...
    return (
        B(() => {
            (p(),
                m(),
                t.value &&
                    (t.value.removeEventListener(`animationstart`, f),
                    t.value.removeEventListener(`animationcancel`, d),
                    t.value.removeEventListener(`animationend`, d)),
                o !== void 0 && s?.clearTimeout(o));
        }),
        {
            isPresent: q(() =>
...
var Cn = K({
    ...
    setup(e, { slots: t, expose: n }) {
        let { present: r, forceMount: i } = G(e),
            a = V(),
            { isPresent: o } = Sn(r, a);
        n({ present: o });
...
export { gn as a, _n as i, bn as n, Z as o, Q as r, Cn as t };
